...
export const REQUIRED_CONSTRAINTS: readonly ConstraintContract[] = [
  ...
  checkConstraint("password_credentials_hash_check", "CHECK (auth.is_supported_password_hash(password_hash))"),
...
export const REQUIRED_FUNCTIONS: readonly FunctionContract[] = [
  ...
  {
    functionName: "is_supported_password_hash",
    identityArguments: "password_hash text",
    returnType: "boolean",
    languageName: "sql",
    volatility: "i",
    ...
    isStrict: false,
    config: ["search_path=pg_catalog, auth"],
    sourceHash: "06e79d47e79518fd9976d86b051225126baec310286eccaef30277a806e15d81",
  },
  {
