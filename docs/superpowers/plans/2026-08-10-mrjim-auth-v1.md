...
**Execution status:** Complete on `feat/mrjim-auth-v1` (2026-08-12). The
checked steps below are backed by the task ledger, per-task reports, and
`pnpm release:check`.
...
- [x] **Step 1: Write the export-boundary test**
...
- [x] **Step 2: Run the test and verify the missing package fails**
...
- [x] **Step 4: Add strict TypeScript and build configuration**
...
- [x] **Step 5: Install dependencies and run workspace checks**
...
- [x] **Step 1: Write type and error contract tests**
...
- [x] **Step 3: Implement the canonical public types**
...
- [x] **Step 4: Implement validated configuration**
...
- [x] **Step 5: Run type and unit checks**
...
- [x] **Step 1: Write fresh-install and naming tests**
...
- [x] **Step 2: Run the migration test against PostgreSQL**
...
- [x] **Step 3: Implement `0001_core.sql`**
...
- [x] **Step 4: Implement authorization and operations migrations**
...
- [x] **Step 5: Implement deterministic migration execution**
...
- [x] **Step 6: Implement CLI commands and schema verification**
...
- [x] **Step 7: Run migration verification**
...
- [x] **Step 2: Run tests and verify adapter failures**
...
- [x] **Step 3: Implement repository interfaces**
...
- [x] **Step 4: Implement Kysely-backed repositories**
...
- [x] **Step 1: Write signing and rotation tests**
...
- [x] **Step 3: Implement cryptographic token primitives**
...
- [x] **Step 4: Implement transactional refresh rotation**
...
- [x] **Step 5: Implement logout scopes**
...
- [x] **Step 6: Run token and concurrency tests**
...
- [x] **Step 1: Write complete lifecycle tests**
...
- [x] **Step 2: Write enumeration equivalence tests**
...
- [x] **Step 4: Implement password and email normalization**
...
- [x] **Step 5: Implement purpose-bound one-time tokens**
...
- [x] **Step 6: Implement mailer calls and audit redaction**
...
- [x] **Step 1: Write PKCE and redirect tests**
...
- [x] **Step 2: Write account-link tests**
...
- [x] **Step 3: Run OAuth tests and verify failures**
...
- [x] **Step 4: Implement OAuth state and callback exchange**
...
- [x] **Step 5: Implement provider adapters**
...
- [x] **Step 6: Implement provider discovery and identity unlinking**
...
- [x] **Step 1: Write permission-matching tests**
...
- [x] **Step 2: Run authorization tests and verify failures**
...
- [x] **Step 3: Implement normalized permission matching**
...
- [x] **Step 4: Implement server enforcement**
...
- [x] **Step 5: Implement current-user permission endpoint**
...
- [x] **Step 4: Implement request dispatch and authentication**
...
- [x] **Step 1: Write client method-shape tests**
...
- [x] **Step 2: Write browser lifecycle tests**
...
- [x] **Step 3: Run client tests and verify failures**
...
- [x] **Step 4: Implement transport and storage**
...
- [x] **Step 5: Implement eventing, locking, and initialization**
...
- [x] **Step 6: Implement all public auth methods**
...
- [x] **Step 7: Run client and browser tests**
...
- [x] **Step 2: Run adapter tests and verify failures**
...
- [x] **Step 3: Implement the Express adapter**
...
- [x] **Step 4: Implement Next.js helpers**
...
- [x] **Step 1: Write administration authorization tests**
...
- [x] **Step 2: Write audit and rate-limit tests**
...
- [x] **Step 4: Implement API keys and server-only client**
...
- [x] **Step 5: Implement transactional administration**
...
- [x] **Step 6: Implement rate-limit hooks**
...
- [x] **Step 7: Run administration tests**
...
- [x] **Step 1: Write documentation example compilation tests**
...
- [x] **Step 2: Run docs tests and verify missing documentation fails**
...
- [x] **Step 3: Write the getting-started and reference documentation**
...
- [x] **Step 4: Write the Supabase compatibility guide**
...
- [x] **Step 5: Build runnable examples**
...
- [x] **Step 6: Run examples and documentation checks**
...
- [x] **Step 1: Write abuse-path tests**
...
- [x] **Step 2: Write compatibility and bundle tests**
...
- [x] **Step 3: Write fresh and upgrade migration tests**
...
- [x] **Step 4: Run targeted security tests**
...
- [x] **Step 5: Implement and run the release gate**
...
- [x] **Step 6: Inspect the packed artifact**
...
- [x] **Step 7: Record v1 release readiness**
